...
func (c *ClusterController) getCurveNodes(namespace string) ([]string, error) {
	curveAppNames := []string{etcd.AppName, mds.AppName, chunkserver.AppName, chunkserver.PrepareJobName, topology.JOB_PYHSICAL_POOL, topology.JOB_LOGICAL_POOL, ReadConfigJobName}
